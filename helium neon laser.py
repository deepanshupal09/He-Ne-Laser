...
def calc():
    ...
    dn = str(dn)
    dn_label = tk.Label(main_win, text="dn=" + dn)
    dn_label.place(x=1000, y=0)
    dn = float(dn)

    wavelength = str(wavelength)
    wavelength_label = tk.Label(main_win, text="λ=" + wavelength)
    wavelength_label.place(x=1500, y=0)
    wavelength = float(wavelength)

    sinthetan=str(sinthetan)
    sinthetan_label=tk.Label(main_win, text="sinθn" + sinthetan)
    sinthetan_label.place(x=1250,y=0)
    sinthetan=float(wavelength)
...
global pic2
# creating image
table=tk.Canvas(main_win, height=1000, width=2000)
table.configure(borderwidth=0,highlightthickness=0,background='yellow')

laser = tk.Canvas(main_win, height=96, width=177)
laser.configure(borderwidth=0,highlightthickness=0,background='yellow')
...
diffraction_pic.configure(borderwidth=0,highlightthickness=0,background='yellow')
...
diffraction_grating.configure(borderwidth=0,highlightthickness=0,background='yellow')
...
laser_straight.configure(borderwidth=0,highlightthickness=0, bg='yellow')
...
screen.configure(borderwidth=0, highlightthickness=0, background='yellow')
